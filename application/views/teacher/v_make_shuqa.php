            ...
            <form class="navbar-form navbar-left" role="search" id="make_shuqa">
                <div class="box-search">
                    ...
                    <div class="box">
                       سمستر
                       <div class="input-append">
                            <select name="semester" id="semester" data-rel="chosen" class="dropdown-select search-area" onchange="load_dropdown_data('make_shuqa','teacher/exam/get_subject/1','dep_subject')">
                    ...
                    <div class="box">
                        دیپارتمنت
                        <div class="input-append">
                            <select name="dep" id="dep" data-rel="chosen"  class="dropdown-select search-area" onchange="load_dropdown_data('make_shuqa','teacher/exam/get_subject','dep_subject/1')">
                                <option value="" selected="selected">همه</option>
                ...
                <div class="search-button">
                    <button type="button" class="btn-add" onclick="load_data('make_shuqa','teacher/exam/make_exam_shuqa','making_shuqa')">جستجو کردن</button>
