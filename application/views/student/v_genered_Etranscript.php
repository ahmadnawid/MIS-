            ...
            <div class="shoqa-head transcript" id="result-sheet" style="font-family:Cambria;direction: ltr;">
                <ul style="margin-bottom:15px;padding-top:25px">
                    <li style="text-align:left;margin-left:50px;width:23%">
                        <table class="table-border table samary-result" style="border: 1px solid #000;direction: ltr;font-size:12px">
                            <tr>
                                <td>StudentID</td>
                    ...
                    <li style="text-align:right;width:7%"><img style="width:60px;height:60px" src="<?php echo base_url();?>img/afghanistan.jpg" data="logo"/></li>
                    <li style="width:24%">
                        <p class="eng-head2">Islamic Republic of Afghanistan</h1>
                    ...
                    <li style="text-align:left;width:7%"><img style="width:60px;height:60px" src="<?php echo base_url();?>img/faculty.png" data="logo"/></li>
                    <li style="text-align:left;width:30%;">
                        <table class="table-border table samary-result" id="trans_property" style="direction: ltr;font-size:12px">
                            <tr>
