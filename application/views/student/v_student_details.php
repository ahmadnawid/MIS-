...
<img style="position: relative;top:200px;right:48%;display:none;z-index:2000" src="<?php echo base_url().'images/ajax-loader.gif'?>" id="modal-loader"/>
    <div style="float:right;border-radius:100%;border:1px solid #fff;border-bottom-color: #eee;background: #fff"><img src="<?php if($student_data[0]['photo']!=''){ echo base_url().$student_data[0]['photo'];}else{ echo base_url().'img/default-photo.png';}?>" style="width:100px;height: 100px;border-radius:100%;padding:8px" disabled="disabled"/></div>
    <h4 style="margin-right: 140px;margin-top:20px;margin-bottom: 3px;"><?php echo $student_data[0]['dari_name'].' '.$student_data[0]['dari_lName'];?></h4>
  </div>
  <div class="modal-header" style="padding-top:10px;padding-bottom:15px;border-bottom:none">
    <p style="margin-right:140px;margin-bottom:0px;"><?php if($student_data[0]['phone_number']!=0) echo '0'.$student_data[0]['phone_number'];?></p>
    <p style="margin-right:140px;"><?php echo $student_data[0]['email'];?></p>
  </div>
        ...
        <div class="tab-pane fade active in" id="set1">
            <div class="tabbable sub">
                ...
                <div class="tab-content" style="width:100%">
                   ...
                   echo form_open_multipart('student/home/edit_student_info/photo_data',$attributes);?>
                    <div class="input-area info">
                        <div class="box-search">
                            <div class="box">
                                عکس
                    ...
                    <button style="float:left;display:none;" id="student_p" type="submit" class="btn-add">ذخیره کردن</button> 
                   </form>
                   </div>
                   <!-- end -->
                </div>
                         ...
                         <div class="input-area info">
                            <table>
                                <thead>
                                    ...
                                    <th style="padding:5px">جزئیات یادداشت</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:5px"><textarea style="width:250px" rows="3" name="details[]" disabled="disabled"><?php echo $m['discription'];?></textarea></td>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <select name="student_dep" data-rel="chosen"  class="dropdown-select input-label su" style="width:220px;">
                                            <option value="">انتخاب کنید</option>
                                            <option value="1">تاجیل</option>
                                            <option value="1">منفک</option>
                                        </select>
                                        <td style="padding:5px"><textarea style="width:250px" rows="3" name="details[]"></textarea></td>
                                        <td style="padding:5px;vertical-align: top"><input type="text" name="year[]" value=""/></td>
                                        <td style="padding:5px;vertical-align: top"><input type="text" name="semester[]" value=""/></td>
                                    </tr>
                                </tbody>
                            </table>
                         </div><!--end input area-->
