<div class="modal-header" style="background:#f28c38;padding-top:10px;border-radius:5px 5px 0 0;color:#fff">
  ...
  <div class="modal-body" style="max-height:450px;" id="subject_update">
  ...
  <div class="modal-footer">
    ...
    <button style="float:left;" type="button" class="btn-add" onclick="update_modal_data('editing_subject','subject/subject_editing/edit_subject','subject_update')">ذخیره کردن</button>
  </div>